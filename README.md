...
| **Prompt** (📝) | Пользовательский промпт: описание вашей личности (persona) и дополнительные инструкции (макс. 500 символов). ИИ формирует из этого блок *USER PROFILE & CUSTOM INSTRUCTIONS*. Пример: «Мужчина 30 лет, программист. Пиши кратко, 1 абзац. Отвечай только на русском». | ❌ OFF |
| **Style** (👤/🍻/💼/💰/💕/😈/🕵️) | Стиль общения: Под пользователя, Друг Гуру, Деловой Гуру, Продавец Гуру, Гуру Романтики, Гуру Соблазнения, Гуру Параноик. Определяет тон и манеру ответов. | 👤 Userlike |
