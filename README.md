...
| **Model** (🤖) | Выбор режима ИИ: FREE (Gemini 3.1 Flash Lite) или PRO. В режиме PRO модель выбирается по стилю общения: для обычных стилей используется GPT-5.4, для flirt/seducer — Gemini 3.1 Pro Preview. Применяется ко всем генерациям — автоответы, черновики и чат с ботом. | FREE |
