...
|-----------|----------|:------------:|
| **Drafts** (✏️) | Включение/выключение обработки черновиков-инструкций. Когда выключено, бот не редактирует черновики по инструкциям, но продолжает создавать авто-ответы на входящие сообщения. | ✅ ON |
...
| **Prompt** (📝) | Пользовательский системный промпт. Добавляется к системным инструкциям для авто-ответов и черновиков. Позволяет задать стиль, тон или правила для всех чатов. | Не задан |
